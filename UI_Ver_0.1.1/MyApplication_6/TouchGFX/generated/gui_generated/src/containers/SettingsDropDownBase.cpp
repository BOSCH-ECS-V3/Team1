    ...
    buttonCallback(this, &SettingsDropDownBase::buttonCallbackHandler)
{
    ...
    Statistics.setLabelText(touchgfx::TypedText(T___SINGLEUSE_C71A));
...
void SettingsDropDownBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    ...
    {
        //StatisticsTempNav
        //When Statistics clicked change screen to Statistics_Temperature
        //Go to Statistics_Temperature with no screen transition
        application().gotoStatistics_TemperatureScreenNoTransition();
    }
}
