...
struct Typography
{
    ...
    static const touchgfx::FontId DATE_DAYS = 5;
    static const touchgfx::FontId AVERAGE_15 = 6;
};
...
struct TypographyFontIndex
{
    ...
    static const touchgfx::FontId TYPOGRAPHY_01 = 3; // verdana_15_4bpp
    static const touchgfx::FontId DATE_DAYS = 0;     // verdana_20_4bpp
    static const touchgfx::FontId AVERAGE_15 = 3;    // verdana_15_4bpp
